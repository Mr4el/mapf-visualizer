...
object CustomColors {
    ...
    // Gui colors
    val ACTIVE_BUTTON_BACKGROUND = Color(0xff715189)
    val ACTIVE_BUTTON_TEXT = WHITE
    val DISABLED_BUTTON_BACKGROUND = Color(0xfffff7fd)
    val DISABLED_BUTTON_TEXT = BLACK
    val ICON_COLOR = Color(0xff715189)
}
