...
import problem.obj.*
import problem.obj.Agent.Companion.hasAgentAt
...
data class ClassicalMapf(
    ...
    fun incrementLatestAgentNumber() {
        latestAgentNumber++
    }

    fun getLatestAgentNumber() = latestAgentNumber
    ...
    fun applySolution(solution: SolutionWithCost) {
